...
ERROR_MESSAGE = """Извините, в данный момент я испытываю технические затруднения с обработкой вашего запроса. В настоящее время наблюдается повышенная нагрузка на сервисы психологической поддержки.

Пожалуйста, попробуйте:
1. Отправить сообщение немного позже (через 5-10 минут)
2. Сформулировать ваш запрос короче или другими словами
3. Использовать команду /reset для начала новой сессии

Спасибо за понимание и терпение! Я готов продолжить нашу беседу, как только это будет возможно."""